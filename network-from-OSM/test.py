...
def main():
    ...
    laneconnections,turninggroups = lc.constructConnections(connSumo,nodes,links,segments,lanes,segToLink) # TODO ERROR

    print "----------Constructed connections-------------" # DONE Iveel
    laneconnections = lc.processAndAddConnections(nodes,tempnodeDict,links,segments,lanes,laneconnections,turninggroups,segToLink)
