...
# FOLDER = 'to_db_baltimore/'
FOLDER = 'to_db_telaviv/'
...
conn = psycopg2.connect("host='18.58.0.111' port='5432' dbname='Please change back!' user='postgres' password='ITSLab2016!'")
